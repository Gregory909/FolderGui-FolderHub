...
TextButton.MouseButton1Down:Connect(function()
	...
	game:GetService("VirtualInputManager"):SendKeyEvent(true, "LeftShift" , false , game)end)
...
if gundrop ~= game.Players.LocalPlayer.Character.HumanoidRootPart then
...
Tab3Section:NewButton("Goto Players Script", "!!Get out!!", function()
...
Tab9Section:NewLabel("mm2 scripts(mobile)")

Tab9Section:NewButton("Symphony Hub", "Give Someone your tools", function()
...
Tab9Section:NewButton("Ski Hub", "nothing", function()

loadstring(game:HttpGet(("https://pastebin.com/raw/mT10xnt7"), true))()

end)

Tab9Section:NewButton("Virbus Hub(Gui)", "nothing", function()
...
Tab9Section:NewLabel("mm2 scripts(pc)")
